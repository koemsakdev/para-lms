                ...
                <form onSubmit={form.handleSubmit(onSubmit)}>
                    <div className="flex flex-col gap-6">
                        ...
                        <div className="flex flex-col gap-4">
                            <p className={"text-sm text-center"}>Enter your email below to login to your account.</p>
                            ...
                            <div className="flex items-center gap-2">
                                <Checkbox
                                    ...
                                    className={"data-[state=checked]:border-blue-600 data-[state=checked]:bg-blue-600 data-[state=checked]:text-white dark:data-[state=checked]:border-blue-700 dark:data-[state=checked]:bg-blue-700 shadow-none rounded-xs focus:shadow-none focus-visible:shadow-none focus:outline-0 focus-visible:outline-0 focus:ring-0 focus-visible:ring-0"}
                                />
